...
STATIC_ASSERT(RTC2_IRQ_PRI == SWI0_IRQ_PRI);
 ...
 */
void rtc2_init(uint32_t prescaler)
{
 ...
 */
void timer_timeouts_check(void)
{
 ...
 */
bool elapsed_ticks_acquire(uint32_t * p_ticks_elapsed)
{
 ...
 */
bool list_deletions_handler(void)
{
 ...
 */
void expired_timers_handler(uint32_t         ticks_elapsed,
 ...
 */
void user_op_enque(timer_user_t * p_user, app_timer_id_t last_index)
{
 ...
 */
timer_user_op_t * user_op_alloc(timer_user_t * p_user, app_timer_id_t * p_last_index)
{        
    app_timer_id_t    last;
 ...
 */
uint32_t timer_start_op_schedule(timer_user_id_t user_id,
                                        app_timer_id_t  timer_id,
 ...
 */
uint32_t timer_stop_op_schedule(timer_user_id_t user_id, app_timer_id_t timer_id)
{
    app_timer_id_t last_index;
 ...
 * @param[in]  user_id    Id of user calling this function.
 */
uint32_t timer_stop_all_op_schedule(timer_user_id_t user_id)
{
    app_timer_id_t last_index;
