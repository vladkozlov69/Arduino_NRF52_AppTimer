 ...
 *
 * @details It enables the application to create multiple timer instances based on the RTC2
 ...
 * @param[in]  timeout_ticks   Number of ticks (of RTC2, including prescaling) to timeout event
 *                             (minimum 5 ticks).
